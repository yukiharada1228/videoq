"""
Django settings for talk_video project.
...
class DefaultSettings:
    ...
    DEFAULT_FROM_EMAIL = "noreply@talkvideo.local"
...
WSGI_APPLICATION = "talk_video.wsgi.application"
...
SPECTACULAR_SETTINGS = {
    "TITLE": "TalkVid API",
    "DESCRIPTION": "API documentation for TalkVid application",
    "VERSION": "1.0.0",
...
if USE_MAILGUN:
    ...
    if "DEFAULT_FROM_EMAIL" not in os.environ and mailgun_sender_domain:
        DEFAULT_FROM_EMAIL = f"TalkVid <noreply@{mailgun_sender_domain}>"
else:
