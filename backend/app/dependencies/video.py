...
from app.composition_root import video as _cr


def get_list_videos_use_case():
    return _cr.get_list_videos_use_case()
...
def get_update_video_use_case():
    return _cr.get_update_video_use_case()


def get_delete_video_use_case():
    return _cr.get_delete_video_use_case()


def get_list_groups_use_case():
    return _cr.get_list_groups_use_case()


def get_create_group_use_case():
    return _cr.get_create_group_use_case()


def get_video_group_use_case():
    return _cr.get_video_group_use_case()


def get_update_group_use_case():
    return _cr.get_update_group_use_case()


def get_delete_group_use_case():
    return _cr.get_delete_group_use_case()


def get_add_video_to_group_use_case():
    return _cr.get_add_video_to_group_use_case()


def get_add_videos_to_group_use_case():
    return _cr.get_add_videos_to_group_use_case()


def get_remove_video_from_group_use_case():
    return _cr.get_remove_video_from_group_use_case()
...
def get_delete_share_link_use_case():
    return _cr.get_delete_share_link_use_case()


def get_shared_group_use_case():
    return _cr.get_shared_group_use_case()


def get_list_tags_use_case():
    return _cr.get_list_tags_use_case()


def get_create_tag_use_case():
    return _cr.get_create_tag_use_case()


def get_tag_detail_use_case():
    return _cr.get_tag_detail_use_case()


def get_update_tag_use_case():
    return _cr.get_update_tag_use_case()


def get_delete_tag_use_case():
    return _cr.get_delete_tag_use_case()


def get_add_tags_to_video_use_case():
    return _cr.get_add_tags_to_video_use_case()
