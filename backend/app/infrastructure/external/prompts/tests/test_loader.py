...
class PromptLoaderTests(TestCase):
    ...
    def test_build_system_prompt_default_locale(self):
        ...
        with patch("app.infrastructure.external.prompts.loader.PROMPTS_PATH", self.prompts_path):
            self._write_config(self.valid_config)
            # Clear cache
            from app.infrastructure.external.prompts.loader import _load_prompt_config
    ...
    def test_build_system_prompt_missing_file(self):
        ...
        with patch(
            "app.infrastructure.external.prompts.loader.PROMPTS_PATH",
            Path("/nonexistent/prompts.json"),
        ):
            from app.infrastructure.external.prompts.loader import _load_prompt_config
