...
vi.mock('@/lib/api', async (importOriginal) => {
  ...
  apiClient: {
    ...
    getVideoCourses: vi.fn(() => Promise.resolve([])),
    getSharedVideoCourse: vi.fn(() => Promise.resolve(null)),
    createVideoCourse: vi.fn(() => Promise.resolve({ id: '1', name: 'New Course', description: 'Description', videos: [] })),
    updateVideoCourse: vi.fn(() => Promise.resolve()),
    deleteVideoCourse: vi.fn(() => Promise.resolve()),
    getVideos: vi.fn(() => Promise.resolve({ data: [], meta: { total: 0, limit: 24, offset: 0 } })),
    getVideoStats: vi.fn(() => Promise.resolve({
      total: 0,
      completed: 0,
      pending: 0,
      processing: 0,
    ...
    getVideoCoursesPage: vi.fn(() => Promise.resolve({ data: [], meta: { total: 0, limit: 1, offset: 0 } })),
    ...
    getSharedCourse: vi.fn(() => Promise.resolve({
      id: 1,
      name: 'Sample course',
      description: '',
      display_order: 0,
