...
class ApiClient {
  ...
  private async handleError(response: Response): Promise<never> {
    ...
    if (errorData && typeof errorData === 'object') {
      ...
      // Legacy fallback: Handle non_field_errors array (DRF validation errors)
