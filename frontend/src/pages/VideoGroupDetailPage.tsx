...
export default function VideoGroupDetailPage() {
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [isAddModalOpen, videoSearch, statusFilter, ordering, selectedTagIds]);
          ...
          <div className="space-y-4 h-full flex flex-col">
            ...
            <div className="lg:hidden flex border-b border-gray-200 bg-white rounded-t-lg">
              <button
                ...
                className={`flex-1 px-4 py-3 text-sm font-medium transition-colors ${mobileTab === 'videos' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-600 hover:text-gray-900'
                  }`}
              >
              ...
              <button
                ...
                className={`flex-1 px-4 py-3 text-sm font-medium transition-colors ${mobileTab === 'player' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-600 hover:text-gray-900'
                  }`}
              >
              ...
              <button
                ...
                className={`flex-1 px-4 py-3 text-sm font-medium transition-colors ${mobileTab === 'chat' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-600 hover:text-gray-900'
                  }`}
              >
