/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --env-interface=CloudflareBindings` (hash: 97da6fd8d1283a3f0e23a6f3d218128f)
// Runtime types generated with workerd@1.20260911.1 2026-08-20 enable_request_signal,nodejs_compat
interface __BaseEnv_CloudflareBindings {
	VIDEO_BUCKET: R2Bucket;
	HYPERDRIVE: Hyperdrive;
	ENVIRONMENT: "production" | "development";
	USE_S3_STORAGE: "true";
	CORS_ALLOW_ORIGIN: "https://videoq.jp" | "http://localhost,http://127.0.0.1,http://127.0.0.1:3000,http://localhost:3000";
	...
	OAUTH_ISSUER_URL: "https://videoq.jp" | "http://localhost";
	...
	STUDY_SESSION: DurableObjectNamespace<import("./src/index").StudySession>;
	TASK_SCHEDULER: DurableObjectNamespace<import("./src/index").TaskScheduler>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RateLimiter" | "StudySession" | "TaskScheduler";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "USE_S3_STORAGE" | "CORS_ALLOW_ORIGIN" | "FRONTEND_URL" | "DEFAULT_FROM_EMAIL" | "MAILGUN_SENDER_DOMAIN" | "COURSE_INVITATION_BATCH_LIMIT" | "MAX_VIDEO_UPLOAD_SIZE_MB" | "DEFAULT_STORAGE_LIMIT_GB" | "DEFAULT_PROCESSING_LIMIT_MINUTES" | "DEFAULT_AI_ANSWERS_LIMIT" | "STRIPE_AUTOMATIC_TAX" | "EMBEDDING_PROVIDER" | "EMBEDDING_MODEL" | "OLLAMA_BASE_URL" | "LLM_MODEL" | "PGVECTOR_COLLECTION_NAME" | "OAUTH_ISSUER_URL" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "USER_SECRET_ENCRYPTION_KEY" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "R2_S3_ENDPOINT" | "R2_BUCKET_NAME" | "R2_S3_REGION" | "SQS_QUEUE_URL" | "AWS_REGION" | "AWS_ACCESS_KEY_ID" | "AWS_SECRET_ACCESS_KEY">> {}
}
